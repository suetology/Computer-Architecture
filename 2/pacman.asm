...
proc DRAW_GRID
    ...
    draw_grid_horizontal:   
        ...
        cmp byte ptr ds:[si], 13    ;   jeigu sutinka carriage return'a, reiskia laikas piesti kita eilute
        je increment_y              
...
proc CALCULATE_WIDTH
    ...
    calculate:
        ...
        add si, 2               ;   prideda 2, nes tam, kad kiti skaiciavimai butu teisingi reikia uzskaityti 
